...
/**
 * Protobuf enum {@code order.PaymentStatus}
 */
public enum PaymentStatus
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return com.cybage.order.Order.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:order.PaymentStatus)
}
